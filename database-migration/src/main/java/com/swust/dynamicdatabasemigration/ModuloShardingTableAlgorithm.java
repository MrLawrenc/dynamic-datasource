...
public class ModuloShardingTableAlgorithm implements PreciseShardingAlgorithm {
    ...
    public static void main(String[] args) throws Exception {
        DataSource dataSource = new ModuloShardingTableAlgorithm().getShardingDataSource();
...
class DataSourceUtil {
    ...
    private static final String HOST = "47.96.158.220";

    private static final int PORT = 13306;

    private static final String USER_NAME = "root";

    private static final String PASSWORD = "@123lmyLMY.";
